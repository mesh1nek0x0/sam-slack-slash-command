...
This is a sample template for sam-slack-slash-command - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name sam-slack-slash-command \
...
```bash
sam logs -n HelloWorldFunction --stack-name sam-slack-slash-command --tail
```
...
```bash
aws cloudformation delete-stack --stack-name sam-slack-slash-command
```
